...
import edu.cnm.deepdive.lofistudio.ProgressBarView;
...
public class BoardActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      sequencer.setSample(0, R.raw.drum_loop_alcoholic);
      sequencer.setSample(1, R.raw.lofi_keys_enter_paradise_c);
      sequencer.setSample(2, R.raw.lofi_keys_time_warp_afriend_c);
      sequencer.setSample(3, R.raw.drum_loop_coffeebreak);
